	...
	var _table = $table.dataTable($.extend(true,
        ...
        columns: [
            ...
            {className : "td-operation",data: null,render : function(data,type, row, meta) {
                ...
                "<button id='editRow' class='btn btn-info btn-xs' type='button' data-toggle='tooltip' data-placement='bottom' title='修改'><i class='ace-icon fa fa-edit bigger-120'></i></button>"+
