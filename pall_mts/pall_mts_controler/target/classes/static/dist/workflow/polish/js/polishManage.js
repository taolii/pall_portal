$(document).ready(function() {
	...
	$.each(tableFieldBinds, function(index, tableField){
		...
		columns_setting.push({className : "ellipsis","defaultContent":"",data:tableField.fieldName,render : TABLE_CONSTANT.DATA_TABLES.RENDER.ELLIPSIS,width:"60px","visible":v_visible }) ;  
	});
