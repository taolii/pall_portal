...
public class KeyConstants {
	 ...
	 * 抛光流程配置表名
	 */
	public static final String WORKFLOW_POLISH_TABLENAME="workflow/polish/tablename";
	/*
	 ...
	 */
	public static final String DATACONFIG_TYPE_CLEAN_DEFECT_WF="dataconfig/type/cleandefect/workingface";
	/*
	 * 清洗表非工作面的缺损信息在数据配置表中的类型
	 */
	public static final String DATACONFIG_TYPE_CLEAN_DEFECT_NWF="dataconfig/type/cleandefect/noworkingface";
	/*
	 * 数据配置表代表clean defect的配置类型
	 */
	public static final String DATACONFIG_TYPE_CLEAN_DEFECT="dataconfig/type/cleandefect";
	/*
	 * 清洗管理页面excel下载子目录名称
	 */
	 ...
	 */
	public static final String DATACONFIG_TYPE_OPTICALFILMING_DEFECT="dataconfig/type/opticalFilmingDefect";
	/*
	 * 光学镀膜流程配置表名
	 */
	public static final String WORKFLOW_OPTICALFILMING_TABLENAME="workflow/opticalFilming/tablename";
	/*
	 * 光学镀膜表工作面的缺损信息在数据配置表中的类型
	 */
	public static final String DATACONFIG_TYPE_OPTICALFILMING_DEFECT_WF="dataconfig/type/opticalFilmingDefect/workingface";
	/*
	 * 光学镀膜表非工作面的缺损信息在数据配置表中的类型
	 */
	public static final String DATACONFIG_TYPE_OPTICALFILMING_DEFECT_NWF="dataconfig/type/opticalFilmingDefect/noworkingface";
	/*
