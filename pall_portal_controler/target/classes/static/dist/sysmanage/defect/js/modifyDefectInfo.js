    	...
    	$.post(contextPath+"/dataconfig/modDataconfig",  $form.serialize(), function(result) {
    		if(result.resultCode==0){
    			Lobibox.alert('success', {
                    msg: "<h3><span class='green'>缺损配置更新成功</span>",
    			...
    			Lobibox.alert('error', {
                    msg: '<span class="red">缺损配置更新失败,详情如下:</span><br/><span class="red icon-exclamation-sign"><i class="glyphicon glyphicon-play"></i>'+result.resultMsg+'</span>',
