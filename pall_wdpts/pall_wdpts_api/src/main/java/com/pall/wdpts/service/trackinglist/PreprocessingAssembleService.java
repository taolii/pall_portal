 ...
 */
@Service
public interface PreprocessingAssembleService {
	/*
	 * 根据条件查询预处理装配记录信息
	...
	/*
	 * 导出预处理装配信息
	 * @param preprocessingAssembleFormQueryEntity 预处理装配信息查询对象
	 * @return 导出结果
	 */
	public BaseResponse exportPreprocessing(PreprocessingFormQueryEntity  preprocessingFormQueryEntity) throws Exception;
	/*
	 * 根据条件查询预处理装配信息
	 * @param psid 预处理唯一标示
	 * @return 查询结果
