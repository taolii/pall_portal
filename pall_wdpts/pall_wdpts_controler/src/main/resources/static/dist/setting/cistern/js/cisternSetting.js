$(document).ready(function() {
	...
	var _table = $table.dataTable($.extend(true,
        ...
        columns: [
            ...
            {className : "ellipsis",data: "cisternModel",title:"水箱型号/Model",render : TABLE_CONSTANT.DATA_TABLES.RENDER.ELLIPSIS,width:"190px"},
            {className : "ellipsis",data: "cisternOptions",title:"水箱选配件/Options",render : TABLE_CONSTANT.DATA_TABLES.RENDER.ELLIPSIS,width:"190px"},
