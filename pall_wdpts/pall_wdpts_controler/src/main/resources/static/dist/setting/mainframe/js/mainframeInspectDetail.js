$(document).ready(function() {
	...
	var $detailTable = $("#mainframeInspectDetailTable").dataTable($.extend(true,
        ...
        ajax : function(data, callback, settings) {//ajax配置为function,手动调用异步查询
            ...
            $.ajax({
                    type: "post",
                    url: contextPath+"/setting/mainframeInspectDetail",
                    cache : false,  //禁用缓存
                    data: param,    //传入已封装的参数
                    dataType: "json",
		        	  ...
		        	  if(datas && datas.length>=2){
		        		 ...
		        		 $.each(datas, function(index, selfcheckResult){
		        			 ...
		        			 if(checkedIndex==index){
		        				component=component+"<label class='checkbox-inline' title='"+selfcheckResult+"' ><input type='checkbox' checked='checked'  name='selfcheckResult_"+meta.row+"' value='"+tempVaule+"'>&nbsp;&nbsp;"+selfcheckResult+"</input></label></br>";
		        			 }else{
		        				component=component+"<label class='checkbox-inline' title='"+selfcheckResult+"'><input type='checkbox'   name='selfcheckResult_"+meta.row+"' value='"+tempVaule+"'>&nbsp;&nbsp;"+selfcheckResult+"</input></label></br>"; 
		        			 }
	 		        	});
		        	  }else{
