	...
	$table.on("change",":checkbox",function() {
	 ...
	 var manage = {
	    ...
	    editItem: function(item) {
	    	LoadPage(contextPath+"/trackinglist/modCistern?cleanid="+item.cleanID+"&operator=");
	    },
	    copyItem: function(item) {
	    	LoadPage(contextPath+"/trackinglist/modCistern?cleanid="+item.cleanID+"&operator=copy");
	    },
	    ...
	    exportItem:function(){
	    	$wrapper.spinModal();
	         $.post(contextPath+"/trackinglist/exportCistern",$queryForm.serializeArray(), function(result) {
	        	 if(result.resultCode==0){
	            ...
	            Lobibox.confirm({
	                ...
	                callback: function ($this, type) {
	                    if (type === 'yes') {
	                    	...
	                    	$.post(contextPath+"/trackinglist/delCistern",{"cleanIDs":cleanIDs}, function(result) {
	                    		if(result.resultCode==0){
