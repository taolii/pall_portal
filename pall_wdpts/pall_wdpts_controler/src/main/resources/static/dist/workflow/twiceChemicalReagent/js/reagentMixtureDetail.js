$(document).ready(function() {
	...
	var $detailTable = $("#detailTable").dataTable($.extend(true,
        ...
        ajax : function(data, callback, settings) {//ajax配置为function,手动调用异步查询
            ...
            $.ajax({
                    type: "post",
                    url: contextPath+"/workflow/twiceReagentMixtureDetail",
                    cache : false,  //禁用缓存
                    data: param,    //传入已封装的参数
                    dataType: "json",
        ...
        columns: [
	        {className : "ellipsis",title:"crID",data: "crID",render : TABLE_CONSTANT.DATA_TABLES.RENDER.ELLIPSIS,"visible":false,"width": "10%"},
	        ...
	        {className : "ellipsis",title:"混合试剂LOT#",data: "reagentsSn",render : TABLE_CONSTANT.DATA_TABLES.RENDER.ELLIPSIS,"width": "30%"}
	     ]
    })).api();
